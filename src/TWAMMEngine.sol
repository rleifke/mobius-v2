...
import "./interfaces/ITWAMMEngine.sol";
...
contract TWAMM is ITWAMMEngine {
...
//         // tokens must remain invariant after mint 
...
//     function swapFrom0To1(uint256 amount0In) external {
...
//     function longTermSwapFrom0To1(uint256 amount0In, uint256 numberOfBlockIntervals) external {
...
//     function swapFrom1To0(uint256 amount1In) external  {
...
//     ///@param numberOfBlockIntervals number of block intervals over which to execute long term order
//     function longTermSwapFrom1To0(uint256 amountBIn, uint256 numberOfBlockIntervals) external  {
...
//         reserveMap[operator] += amountIn;
//         reserveMap[recipient] -= amountOutMinusFee;
